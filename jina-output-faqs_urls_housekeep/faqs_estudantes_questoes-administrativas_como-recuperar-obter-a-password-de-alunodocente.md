# Response for https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-recuperar-obter-a-password-de-alunodocente

Title: Como recuperar, obter e alterar a senha, password de aluno, docente ou professor? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-recuperar-obter-a-password-de-alunodocente

Markdown Content:
Como recuperar, obter e alterar a senha, password de aluno, docente ou professor? | Universidade Lusófona
===============

 

Como recuperar, obter e alterar a senha, password de aluno, docente ou professor?
=================================================================================
...
Para obter a password de aluno, que dá acesso às plataformas administrativas e pedagógicas ([netPA](https://secure.ensinolusofona.pt/ulht/secretaria_virtual/page) e [Moodle](https://moodle.ensinolusofona.pt/)) consulte os passos seguintes.

*   Aceda ao [netPA](https://secure.ensinolusofona.pt/ulht/secretaria_virtual/page) - Entrar, escolha a opção **"Esqueceu a palavra passe".**![Image 13: Recuperar-passe-foto-1](https://www.ulusofona.pt/media/recuperar-passe-foto-1.png)
    
*   De seguida, introduza o seu código de aluno alfanumérico sem espaços, (a22xxxxx) e clique na opção **Iniciar processo de definição de password**.![Image 14: Recuperar-passe-foto-2](https://www.ulusofona.pt/media/recuperar-passe-foto-2.png)
    
*   Após a submissão do pedido, o sistema irá solicitar a introdução da nova palavra-chave através do URL enviado para o email registado na ficha de aluno.

Recomendamos que adicione o email [gestao.utilizadores@mail.ulusofona.pt](mailto:gestao.utilizadores@mail.ulusofona.pt) à lista de endereços fidedignos, e verifique na diretoria de spam se existem emails enviados do endereço de recuperação.
