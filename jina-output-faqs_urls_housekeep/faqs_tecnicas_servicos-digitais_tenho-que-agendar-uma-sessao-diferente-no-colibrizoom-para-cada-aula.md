# Response for https://www.ulusofona.pt/faqs/tecnicas/servicos-digitais/tenho-que-agendar-uma-sessao-diferente-no-colibrizoom-para-cada-aula

Title: Tenho que agendar uma sessão diferente no Colibri(Zoom) para cada aula? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/tecnicas/servicos-digitais/tenho-que-agendar-uma-sessao-diferente-no-colibrizoom-para-cada-aula

Markdown Content:
Tenho que agendar uma sessão diferente no Colibri(Zoom) para cada aula? | Universidade Lusófona
===============

 

Tenho que agendar uma sessão diferente no Colibri(Zoom) para cada aula?
=======================================================================
...
Pode agendar no [Zoom](https://www.ulusofona.pt/sistema-zoom) uma sessão para cada aula e fornecer no Moodle o link para cada uma das diferentes sessões (indicando o dia e hora da mesma). Pode também optar por partilhar o link para a sua sala de perfil. Deste modo o link para todas as sessões será sempre o mesmo, cabendo ao Docente a responsabilidade de se juntar à sala online nos dias e horas previstos no horário. Ver vídeo explicativo [aqui](https://educast.fccn.pt/vod/clips/k0qwed819/html5.html?locale=pt)
