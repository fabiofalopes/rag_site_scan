# Response for https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-solicitar-a-declaracao-para-o-sef

Title: Como solicitar a declaração para o SEF? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-solicitar-a-declaracao-para-o-sef

Markdown Content:
Como solicitar a declaração para o SEF? | Universidade Lusófona
===============

 

Como solicitar a declaração para o SEF?
=======================================
...
As declarações para estudantes estrangeiros | internacionais são solicitadas através do [netPA](https://secure.ensinolusofona.pt/ulht/secretaria_virtual/page?stage=browservalidator&acknoledge=true), na secção [Requisitar Pedidos](https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-efetuar-um-pedido-no-netpa).

Se é aluno externo, deverá selecionar a opção **Declaração de Inscrição para Aluno Externo Estrangeiro | Internacional**.

Se é aluno interno, deverá selecionar a opção **Declaração de Matrícula de Aluno Externo Estrangeiro | Internacional** ou a opção **Declaração de Inscrição de Aluno Externo Estrangeiro | Internacional**.

Quando o documento estiver para entrega, poderá descarregar a sua versão digital, consultando os procedimentos descritos [aqui](https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-obter-documentos-solicitados-em-pedidos-no-netpa).

Para requisitar documentos, deverá ter a sua situação financeira regularizada, nomeadamente efetuar o [pagamento](https://www.ulusofona.pt/faqs/estudantes/financeiras/como-posso-aceder-aos-dados-para-pagamento-mb-paypal-cartao-de-credito-e-mb-way) da matrícula, da inscrição, do seguro escolar e das duas primeiras propinas integralmente.

Consulte esta informação na respetiva [Ordem de Serviço](https://www.ulusofona.pt/media/regras-aplicadas-ao-pagamento-de-propinas.pdf).

Pode verificar o valor do emolumento consultando a [Ordem de Serviço de Emolumentos](https://www.ulusofona.pt/documentos?cat=5) em vigor.
