# Response for https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/para-que-serve-o-pedido-de-questoes-financeiras

Title: Para que serve o pedido de questões financeiras? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/para-que-serve-o-pedido-de-questoes-financeiras

Markdown Content:
Para que serve o pedido de questões financeiras? | Universidade Lusófona
===============

 

Para que serve o pedido de questões financeiras?
================================================
...
Este pedido deve ser utilizado para todos os assuntos relacionados com a área financeira, por exemplo, associação de valores na sua conta de aluno, valores a recuperar após anulação de inscrição, esclarecimento sobre valores de campanhas não lançados, entre outros.

O pedido é solicitado na secção [Requisitar Pedidos](https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-efetuar-um-pedido-no-netpa), selecionando a opção **Questões Financeiras**.
