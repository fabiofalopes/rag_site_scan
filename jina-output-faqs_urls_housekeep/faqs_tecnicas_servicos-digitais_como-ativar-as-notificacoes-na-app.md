# Response for https://www.ulusofona.pt/faqs/tecnicas/servicos-digitais/como-ativar-as-notificacoes-na-app

Title: Como ativar as notificações na APP? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/tecnicas/servicos-digitais/como-ativar-as-notificacoes-na-app

Markdown Content:
Como ativar as notificações na APP? | Universidade Lusófona
===============

 

Como ativar as notificações na APP?
===================================
...
1.  No canto superior direito, carregando nos pontos aparece a opção **Definição de Notificações** e depois basta **Ativar**.
    

![Image 13: notificaçoesAPP-1](https://www.ulusofona.pt/images/notificacoesapp-1_1920.jpg)

2\. Depois receba os alertas a avisar de:

**Data, hora e sala para exame -** Antes do exame irá ser notificado sobre o local e hora onde o mesmo se irá realizar.

**Lançamento de notas -** Sempre que uma nova nota for lançada receberá uma notificação a avisar.

![Image 14: notificaçoesAPP-2](https://www.ulusofona.pt/images/notificacoesapp-2_1920.jpg)
