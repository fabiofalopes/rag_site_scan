# Response for https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/preciso-dos-conteudos-programaticos-do-meu-curso-como-posso-solicitar

Title: Preciso dos conteúdos programáticos do meu curso. Como posso solicitar? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/preciso-dos-conteudos-programaticos-do-meu-curso-como-posso-solicitar

Markdown Content:
Preciso dos conteúdos programáticos do meu curso. Como posso solicitar? | Universidade Lusófona
===============

 

Preciso dos conteúdos programáticos do meu curso. Como posso solicitar?
=======================================================================
...
Pode solicitar os conteúdos programáticos do curso através do seu [netPA](https://secure.ensinolusofona.pt/ulht/secretaria_virtual/page?stage=browservalidator&acknoledge=true), na secção [Requisitar Pedidos](https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-efetuar-um-pedido-no-netpa).

Se pretender os conteúdos programáticos de algumas Unidades Curriculares apenas, deverá selecionar a opção **Conteúdos Programáticos por Unidade Curricular (FUC)** (valor sob consulta na Ordem de Serviço por FUC) e deverá indicar no motivo do pedido o nome das disciplinas pretendidas.

Se pretender os conteúdos programáticos de todo o curso deverá selecionar a opção **Conteúdos Programáticos do Curso (FUC)** (valor sob consulta na Ordem de Serviço por FUC) e deverá indicar no motivo do pedido exatamente o que pretende. Esta opção é exclusiva para alunos diplomados.

Os pedidos referidos compreendem o respetivo [pagamento](https://www.ulusofona.pt/faqs/estudantes/financeiras/como-posso-aceder-aos-dados-para-pagamento-mb-paypal-cartao-de-credito-e-mb-way), que pode verificar consultando a [Ordem de Serviço de Emolumentos](https://www.ulusofona.pt/documentos?cat=5) em vigor.
