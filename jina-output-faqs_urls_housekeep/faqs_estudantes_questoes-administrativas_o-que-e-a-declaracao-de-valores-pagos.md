# Response for https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/o-que-e-a-declaracao-de-valores-pagos

Title: O que é a Declaração de valores pagos? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/o-que-e-a-declaracao-de-valores-pagos

Markdown Content:
O que é a Declaração de valores pagos? | Universidade Lusófona
===============

 

O que é a Declaração de valores pagos?
======================================
...
A declaração de valores pagos corresponde a uma declaração descritiva dos itens que pagou e o respetivo valor, por ano letivo (se não houver indicação em contrário é feita a declaração correspondente ao ano letivo inscrito ou último ano letivo inscrito). A conta corrente tem de se encontrar regularizada. O documento é entregue em formato papel.
