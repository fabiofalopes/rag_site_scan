# Response for https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-efetuar-anulacao-de-inscricao-as-disciplinas

Title: Como efetuar anulação de inscrição às disciplinas? | Universidade Lusófona

URL Source: https://www.ulusofona.pt/faqs/estudantes/questoes-administrativas/como-efetuar-anulacao-de-inscricao-as-disciplinas

Markdown Content:
Como efetuar anulação de inscrição às disciplinas? | Universidade Lusófona
===============

 

Como efetuar anulação de inscrição às disciplinas?
==================================================
...
**Passo 1:** Faça login no seu [netPA](https://secure.ensinolusofona.pt/ulht/secretaria_virtual/page) .**Passo 2:** Clique em “Matrícula/Inscrição”.

**Passo 3:** As disciplinas às quais está inscrito aparecem selecionadas. Deverá clicar no quadrado correspondente para deixarem de estar selecionadas e em seguida clique em “Continuar”.

![Image 13: Inscrição_anular_02](https://www.ulusofona.pt/media/inscricaoanular02.png)

**Passo 4:**Irá surgir o resumo das disciplinas às quais pretende anulação. Deverá verificar e confirmar.

![Image 14: Inscrição_anular_03](https://www.ulusofona.pt/media/inscricaoanular03.png)

Caso pretenda anulação a todas as unidades curriculares, surgirá este erro. Deverá dirigir-se ao SIGA | Serviço Integrado de Gestão de Alunos para regularizar a situação.

![Image 15: Inscrição_anular_04](https://www.ulusofona.pt/media/inscricaoanular04.png)

Caso tenha valores a pagamento irá surgir a indicação “Matrícula Inválida”. ![Image 16: Inscrição_anular_05](https://www.ulusofona.pt/media/inscricaoanular05.png)

Deverá proceder à regularização do valor a pagamento. Após a regularização, não é necessário apresentar novamente o pedido de anulação, visto que o pedido anterior é considerado.
